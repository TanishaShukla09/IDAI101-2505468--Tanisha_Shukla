...
- UserWeightIntent  
                     		          - ShowMealPlanIntent  
                    			           - ExerciseIntent / HydrationIntent / HealthySnackIdeaIntent  
                              			      - SetReminderIntent  
In order to make the experience less frictional and more user-friendly, context transitions could be employed, including goal-followup, gender-followup and age-followup to allow transition of one step to the next.
